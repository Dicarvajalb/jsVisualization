...
import JavaScriptParserBase from '../base/JavaScriptParserBase.js';
...
0,48,59,1,0,63,67,1,0,68,71,3,0,107,107,112,112,119,119,1,0,111,112,1201,
0,155,1,0,0,0,2,162,1,0,0,0,4,184,1,0,0,0,6,186,1,0,0,0,8,193,1,0,0,0,10,
197,1,0,0,0,12,212,1,0,0,0,14,214,1,0,0,0,16,231,1,0,0,0,18,236,1,0,0,0,
20,242,1,0,0,0,22,245,1,0,0,0,24,262,1,0,0,0,26,274,1,0,0,0,28,279,1,0,0,
0,30,281,1,0,0,0,32,284,1,0,0,0,34,293,1,0,0,0,36,298,1,0,0,0,38,300,1,0,
0,0,40,304,1,0,0,0,42,369,1,0,0,0,44,374,1,0,0,0,46,376,1,0,0,0,48,383,1,
0,0,0,50,390,1,0,0,0,52,397,1,0,0,0,54,404,1,0,0,0,56,410,1,0,0,0,58,416,
...
export default class JavaScriptParser extends JavaScriptParserBase {
	...
	iterationStatement() {
	    ...
	    try {
	        ...
	        case 3:
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            if((((_la) & ~0x1f) == 0 && ((1 << _la) & 66060976) !== 0) || ((((_la - 61)) & ~0x1f) == 0 && ((1 << (_la - 61)) & 809650175) !== 0) || ((((_la - 95)) & ~0x1f) == 0 && ((1 << (_la - 95)) & 117602593) !== 0)) {
	                this.state = 334;
	                this.expressionSequence();
	            }
	...
	catchProduction() {
	    ...
	    try {
	        ...
	        if(_la===7) {
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            if(_la===5 || _la===9 || ((((_la - 107)) & ~0x1f) == 0 && ((1 << (_la - 107)) & 4129) !== 0)) {
	                this.state = 464;
	                this.assignable();
	            }
	...
	functionDeclaration() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if((((_la) & ~0x1f) == 0 && ((1 << _la) & 262688) !== 0) || ((((_la - 107)) & ~0x1f) == 0 && ((1 << (_la - 107)) & 4129) !== 0)) {
	            this.state = 487;
	...
	elementList() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if((((_la) & ~0x1f) == 0 && ((1 << _la) & 66323120) !== 0) || ((((_la - 61)) & ~0x1f) == 0 && ((1 << (_la - 61)) & 809650175) !== 0) || ((((_la - 95)) & ~0x1f) == 0 && ((1 << (_la - 95)) & 117602593) !== 0)) {
	            this.state = 622;
	            this.arrayElement();
	        }
	...
	singleExpression(_p) {
	    ...
	    try {
	        ...
	        case 2:
	            ...
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            if(((((_la - 107)) & ~0x1f) == 0 && ((1 << (_la - 107)) & 4129) !== 0)) {
	                this.state = 731;
	                this.identifier();
	            }
